...
export declare type RequireFields<T, K extends keyof T> = Omit<T, K> & { [P in K]-?: NonNullable<T[P]> };
...
export declare type QueryListUsersArgs = {
...
export declare type QuerySyncUsersArgs = {
  filter?: InputMaybe<ModelUserFilterInput>;
...
export declare type SubscriptionOnCreateUserArgs = {
  filter?: InputMaybe<ModelSubscriptionUserFilterInput>;
  id?: InputMaybe<Scalars['String']>;
};
export declare type SubscriptionOnDeleteUserArgs = {
  filter?: InputMaybe<ModelSubscriptionUserFilterInput>;
  id?: InputMaybe<Scalars['String']>;
};
export declare type SubscriptionOnUpdateUserArgs = {
  filter?: InputMaybe<ModelSubscriptionUserFilterInput>;
  id?: InputMaybe<Scalars['String']>;
};
...
export declare type ModelSubscriptionFloatInput = {
  between?: InputMaybe<Array<InputMaybe<Scalars['Float']>>>;
  eq?: InputMaybe<Scalars['Float']>;
  ge?: InputMaybe<Scalars['Float']>;
  gt?: InputMaybe<Scalars['Float']>;
...
export declare enum ModelSubscriptionLevel {
  Off = "off",
  On = "on",
  Public = "public",
}
export declare type ModelSubscriptionMap = {
...
export declare enum PredictionsActions {
  ConvertTextToSpeech = "convertTextToSpeech",
  IdentifyLabels = "identifyLabels",
  IdentifyText = "identifyText",
  TranslateText = "translateText",
}
export declare type SearchableQueryMap = {
  search?: InputMaybe<Scalars['String']>;
};
export declare type TimestampConfiguration = {
...
export declare type Aws_Api_KeyDirectiveArgs = {};
export declare type Aws_Api_KeyDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_Api_KeyDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_AuthDirectiveArgs = {
  cognito_groups: Array<Scalars['String']>;
};
export declare type Aws_AuthDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_AuthDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_Cognito_User_PoolsDirectiveArgs = {
  cognito_groups?: Maybe<Array<Scalars['String']>>;
};
export declare type Aws_Cognito_User_PoolsDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_Cognito_User_PoolsDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_IamDirectiveArgs = {};
export declare type Aws_IamDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_IamDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_LambdaDirectiveArgs = {};
export declare type Aws_LambdaDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_LambdaDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_OidcDirectiveArgs = {};
export declare type Aws_OidcDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_OidcDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type Aws_SubscribeDirectiveArgs = {
  mutations: Array<Scalars['String']>;
};
export declare type Aws_SubscribeDirectiveResolver<Result, Parent, ContextType = any, Args = Aws_SubscribeDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type BelongsToDirectiveArgs = {
  fields?: Maybe<Array<Scalars['String']>>;
};
export declare type BelongsToDirectiveResolver<Result, Parent, ContextType = any, Args = BelongsToDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type DefaultDirectiveArgs = {
  value: Scalars['String'];
};
export declare type DefaultDirectiveResolver<Result, Parent, ContextType = any, Args = DefaultDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type FunctionDirectiveArgs = {
  name: Scalars['String'];
  region?: Maybe<Scalars['String']>;
};
export declare type FunctionDirectiveResolver<Result, Parent, ContextType = any, Args = FunctionDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type HasManyDirectiveArgs = {
  fields?: Maybe<Array<Scalars['String']>>;
  indexName?: Maybe<Scalars['String']>;
  limit?: Maybe<Scalars['Int']>;
};
export declare type HasManyDirectiveResolver<Result, Parent, ContextType = any, Args = HasManyDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type HasOneDirectiveArgs = {
  fields?: Maybe<Array<Scalars['String']>>;
};
export declare type HasOneDirectiveResolver<Result, Parent, ContextType = any, Args = HasOneDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type HttpDirectiveArgs = {
  headers?: Maybe<Array<Maybe<HttpHeader>>>;
  method?: Maybe<HttpMethod>;
  url: Scalars['String'];
};
export declare type HttpDirectiveResolver<Result, Parent, ContextType = any, Args = HttpDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type IndexDirectiveArgs = {
  name?: Maybe<Scalars['String']>;
  queryField?: Maybe<Scalars['String']>;
  sortKeyFields?: Maybe<Array<Scalars['String']>>;
};
export declare type IndexDirectiveResolver<Result, Parent, ContextType = any, Args = IndexDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type KeyDirectiveArgs = {
  fields: Array<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  queryField?: Maybe<Scalars['String']>;
};
export declare type KeyDirectiveResolver<Result, Parent, ContextType = any, Args = KeyDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type ManyToManyDirectiveArgs = {
  limit?: Maybe<Scalars['Int']>;
  relationName: Scalars['String'];
};
export declare type ManyToManyDirectiveResolver<Result, Parent, ContextType = any, Args = ManyToManyDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type MapsToDirectiveArgs = {
  name: Scalars['String'];
};
export declare type MapsToDirectiveResolver<Result, Parent, ContextType = any, Args = MapsToDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type ModelDirectiveArgs = {
...
export declare type ModelDirectiveResolver<Result, Parent, ContextType = any, Args = ModelDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type PredictionsDirectiveArgs = {
  actions: Array<PredictionsActions>;
};
export declare type PredictionsDirectiveResolver<Result, Parent, ContextType = any, Args = PredictionsDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type PrimaryKeyDirectiveArgs = {
  sortKeyFields?: Maybe<Array<Maybe<Scalars['String']>>>;
};
export declare type PrimaryKeyDirectiveResolver<Result, Parent, ContextType = any, Args = PrimaryKeyDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
export declare type SearchableDirectiveArgs = {
  queries?: Maybe<SearchableQueryMap>;
};
export declare type SearchableDirectiveResolver<Result, Parent, ContextType = any, Args = SearchableDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export declare type ModelUserConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ModelUserConnection'] = ResolversParentTypes['ModelUserConnection']> = {
